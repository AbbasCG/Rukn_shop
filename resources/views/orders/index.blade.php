<x-app-layout>
    <div class="min-h-screen flex flex-col max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8" style="font-family: 'Signika', sans-serif;">
        <!-- Page Header -->
        <div class="space-y-2 text-center sm:text-left">
            <h1 class="text-4xl md:text-5xl font-bold text-primary-dark tracking-tight">My Orders</h1>
            <p class="text-base md:text-lg text-neutral-600">View your recent purchases and their status.</p>
        </div>
        ...
        @if($orders->isEmpty())
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-primary-gray/60 p-12 text-center">
                ...
                <h2 class="text-2xl font-bold text-primary-dark mb-2">You have not placed any orders yet.</h2>
                <p class="text-neutral-600 mb-8">Start shopping to see your orders here.</p>
                <a
                ...
                @foreach($orders as $order)
                    <div class="bg-white rounded-2xl shadow-sm border border-primary-gray/60 p-4 md:p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4 hover:shadow-md transition">
                        <div class="flex-1 space-y-2">
                            ...
                            <p class="text-sm text-neutral-700"><span class="font-medium">Total:</span> €{{ number_format($order->total, 2, ',', '.') }}</p>
                        </div>
