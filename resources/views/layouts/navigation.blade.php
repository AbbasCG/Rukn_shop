<nav x-data="{ open: false }" class="bg-primary-gray border-b border-primary-gray fixed top-0 left-0 w-full z-50 shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl">
    <!-- Primary Navigation Menu -->
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center transition-all duration-300" style="height: 80px;">
            <!-- Logo -->
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="flex items-center me-4">
                    <a href="{{ route('cart.index') }}" class="inline-flex items-center justify-center p-2 rounded-md text-primary-dark hover:text-primary-dark hover:bg-primary-dark/5 focus:outline-none focus:bg-primary-gray focus:text-primary-dark transition duration-300 ease-in-out transform hover:scale-110 hover:rotate-12 {{ request()->routeIs('cart.*') ? 'text-primary-dark bg-primary-gray' : '' }}" title="{{ __('Shopping Cart') }}">
                        <svg class="h-6 w-6 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-primary-dark bg-primary-light hover:bg-primary-dark/10 focus:outline-none transition ease-in-out duration-300 transform hover:scale-105">
                            <div class="transition-colors duration-300">{{ Auth::user()->name }}</div>
                ...
                <div class="flex items-center">
                    <a href="{{ route('login') }}" class="inline-flex items-center justify-center p-2 rounded-md text-primary-dark hover:text-primary-dark hover:bg-primary-dark/5 focus:outline-none focus:bg-primary-gray focus:text-primary-dark transition duration-300 ease-in-out transform hover:scale-110 {{ request()->routeIs('login') ? 'text-primary-dark bg-primary-gray' : '' }}">
                        <svg class="h-6 w-6 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-primary-dark hover:text-primary-dark hover:bg-primary-dark/5 focus:outline-none focus:bg-primary-gray focus:text-primary-dark transition duration-300 ease-in-out transform hover:scale-110">
