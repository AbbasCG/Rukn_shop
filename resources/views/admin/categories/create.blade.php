...
<div class="w-full max-w-3xl mx-auto space-y-6">
    <!-- Header Section -->
    <div>
        <h1 class="text-3xl font-bold text-primary-dark">Create Category</h1>
        <p class="text-sm text-primary-dark/60 mt-1">Add a new product category to organize your inventory</p>
    </div>

    <!-- Form Card -->
    <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-white rounded-xl shadow-lg p-8 space-y-6">
        @csrf
        ...
        <div>
            ...
            <textarea 
                ...
                class="w-full px-4 py-2.5 rounded-lg border border-primary-gray bg-white text-primary-dark placeholder-primary-dark/40 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-dark/20 focus:border-primary-dark hover:border-primary-dark/50">{{ old('description') }}</textarea>
