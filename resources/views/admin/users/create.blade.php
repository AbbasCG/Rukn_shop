...
<div class="w-full max-w-4xl mx-auto">
    <!-- Header Section -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-primary-dark">{{ __('Create New User') }}</h1>
        <p class="mt-2 text-sm text-primary-dark/60">{{ __('Add a new user to the system') }}</p>
    </div>

    <!-- Create Form -->
    <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6 bg-white p-8 rounded-xl shadow-lg">
        @csrf
